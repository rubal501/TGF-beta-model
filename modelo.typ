...
$
  TGFBRA & = TGFBRA dot hill(TGFB, N1, #K1)
           - #g1 dot SMAD dot TGFBRA
           - #d1 dot TGFBRA \
  RSMADA & = RSMADA dot hill(TGFBRA, 1, #K2) dot (1/(1 + SMAD))
           - #d2 RSMADA dot SMAD \
    SMAD & = #a1 dot RSMADA
           - #d3 dot SMAD
$
